...
{
    internal class DeliveryDateValidator : IValidator<DateTime>
    {
        public void Validate(DateTime value)
        {
            {
                if (value == default)
                    throw new DeliveryDateDefaultValueException(ExceptionMessages.DATE_IS_DEFAULT_VALUE, nameof(value), value);

                if (value > DateTime.UtcNow)
                    throw new DeliveryDateFromFutureException(ExceptionMessages.DATE_IS_FUTURE_VALUE, nameof(value), value);
